...
import smallAppliancesImg from "@/assets/categories/Small-Appliances.jpg";
import largeAppliancesImg from "@/assets/categories/largeAppliancesImg.jpg";
import flooringLaminatesImg from "@/assets/categories/flooringLaminatesImg.jpg";
...
const Products = () => {
  ...
  const categories = [
    ...
    },
    {
      ...
      image: smallAppliancesImg,
      description: "Compact kitchen and home convenience appliances",
    },
    {
      id: 11,
      name: "Large Appliances",
      image: largeAppliancesImg,
      description: "Premium appliances and entertainment systems",
    },
    {
      id: 12,
      name: "Flooring & Laminates",
      image: flooringLaminatesImg,
      description: "Premium flooring solutions and decorative laminates",
    },
    {
      id: 13,
      name: "Kitchen",
      image: kitchenImg,
      description: "Kitchen cabinets, sinks, and modular fittings",
    },
    {
      id: 14,
