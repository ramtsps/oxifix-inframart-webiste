  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <Welcome
        ...
        testimonial={{
          quote:
            "We believe in creating shared value and sustainable growth. Join us to be part of Inframart's journey toward building a stronger, brighter future together.",
