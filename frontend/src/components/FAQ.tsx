...
const faqs = [
  {
    ...
    answer: "Oxifix Inframart offers a comprehensive range of construction and home-improvement materials — including electricals, plumbing, sanitaryware, paints, tiles, hardware, tools, kitchen fittings, and appliances. We ensure that every product meets industry standards and is sourced from trusted national and international brands.",
    isOpen: true,
  },
  {
                ...
                >
                  <div>
                    <CollapsibleTrigger className="flex items-center justify-between w-full text-left group">
                      ...
                      <div
                        className={`flex-shrink-0 w-8 h-8 sm:w-10 sm:h-10 rounded-full flex items-center justify-center transition-all duration-300 ease-in-out ${openIndex === index
                          ? "bg-foreground text-background scale-105"
                          : "bg-primary text-primary-foreground group-hover:scale-105"
                          }`}
                      >
                        <ArrowRight
                          className={`w-4 h-4 sm:w-5 sm:h-5 transition-transform duration-300 ease-in-out ${openIndex === index ? "-rotate-45" : "rotate-45"
                            }`}
                        />
                      </div>
                    </CollapsibleTrigger>
