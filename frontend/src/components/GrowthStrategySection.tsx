    ...
    subtitle = "A carefully crafted, multi-phase journey from regional dominance to national leadership in India's retail infrastructure landscape.", phases = [
        {
            ...
            stores: "10 Stores",
            revenue: "₹100 Crore",
            description: "Establish stores across the southern states, targeting deep market penetration and building brand recognition in key initial markets.",
            timeline: "Year 1-2",
        ...
        },
        {
            ...
            stores: "100 Stores",
            revenue: "₹550 Crore",
            description: "Expand stores across multiple regions, projecting significant annual revenue. This phase is critical, as we aim for an IPO listing within 2–3 years.",
            timeline: "Year 2-3",
        ...
        },
        {
            ...
            stores: "1000 Stores",
            revenue: "₹6000 Crore",
            description: "Achieve a complete national footprint, solidifying Infra Mart as a household name in retail and construction supplies across India.",
            timeline: "Year 4-5",
            regions: "Pan-India",
            highlight: false,
