          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              ...
              <div className="space-y-4   text-muted-foreground leading-relaxed text-base sm:text-lg">
                <p>
                  At Inframart, we are committed to making every home project seamless and stress-free. From bath fittings and plywood to electricals and paints, we provide everything under one roof. All our products come from trusted brands, ensuring quality, durability, and safety. With expert guidance at every step, we help our customers make informed choices.
                </p>

                <p>
                  We prioritize convenience and reliability in every interaction. Timely delivery and personalized support are at the heart of our service.
                </p>

                <p>
                  Whether you’re building a new home or renovating an existing one, Inframart is your go-to partner. Our comprehensive solutions save time and effort, allowing you to focus on bringing your vision to life. By combining innovation and quality, we create spaces that are functional, beautiful, and built to last. With Inframart, every project becomes a smooth and satisfying experience.
                </p>
