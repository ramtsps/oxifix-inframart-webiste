              ...
              <div className="space-y-6 lg:pt-20">
                <div className="space-y-4 sm:space-y-6">
                  ...
                  <div className="space-y-4 sm:space-y-6">
                    ...
                    >
                      <p>
                        Oxifix Inframart is a trusted partner for contractors, engineers, and builders. Our mission is to simplify construction sourcing through innovation, quality, and service excellence. Backed by strong industry expertise and reliable vendor partnerships, we deliver comprehensive infrastructure and building solutions for residential, commercial, and industrial projects.
                      </p>
