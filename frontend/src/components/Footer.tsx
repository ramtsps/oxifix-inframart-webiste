        ...
        <div className="grid md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            ...
            <p className="text-white leading-relaxed mb-6">
              Our customers, partners, and community benefit from our commitment to quality, reliability, and seamless service. We deliver excellence in every product, every installation, and every interaction.
            </p>
