...
const InvestorProposalSection: React.FC<InvestorProposalSectionProps> = ({
    ...
    description = "Be part of our visionary journey to redefine construction and home solutions retail across India. We're offering limited founding investor positions in our rapidly expanding network.",
}) => {
    useAOS();
